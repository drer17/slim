...
INSERT INTO "new_AssetLiability" ("archivedAt", "assetTypeId", "color", "createdAt", "description", "icon", "id", "label", "liability", "parentId", "portfolioId", "starred", "taxProfileId") SELECT "archivedAt", "assetTypeId", "color", "createdAt", "description", "icon", "id", "label", coalesce("liability", false) AS "liability", "parentId", "portfolioId", "starred", "taxProfileId" FROM "AssetLiability";
